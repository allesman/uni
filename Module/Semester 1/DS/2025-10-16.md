...
| --------------- | ----------------------------------------- | ------------------------------------------- |
| direkter Beweis | Nimm A an, beweis damit B                 | ![[DS-Slides.pdf#page=46\|DS-Slides, p.46]] |
| Kontraposition  | Nimm $\lnot A$ an, beweis damit $\lnot B$ | ![[IMG_20251016_150731310 copy 2.png]]      |
